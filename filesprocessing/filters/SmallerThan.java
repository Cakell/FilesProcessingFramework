...
public class SmallerThan implements FileFilter{
    ...
    /**
     * Filters files whose size is strictly smaller than the given number of k-bytes.
     * @param someSizeInKiloBytes the size limit, of which only files with smaller size will be filtered.
     * @throws BadParametersWarning if the given size limit is not a double or it is a negative number.
     */
    public SmallerThan(String someSizeInKiloBytes) throws BadParametersWarning {
        try {
     ...
     * abstract pathname is Smaller than the filter's given size.
     */
    @Override
